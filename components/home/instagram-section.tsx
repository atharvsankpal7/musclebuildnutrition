  ...
  const instagramPosts = [
    {
      ...
      likes: 115,
      comments: 4,
      hashtags: ['#Musclebuild Nutritionathlete', '#Musclebuild Nutrition', '#Musclebuild Nutritionsupplements', '#workoutmotivation', '#nevergiveup']
    },
    {
      id: 4,
      ...
      likes: 156,
      comments: 8,
      hashtags: ['#fitness', '#motivation', '#Musclebuild Nutrition']
    },
    {
      id: 2,
      ...
      likes: 95,
      comments: 3,
      hashtags: ['#workout', '#fitness', '#Musclebuild Nutrition']
    },
    {
      id: 3,
      ...
      likes: 87,
      comments: 2,
      hashtags: ['#supplements', '#protein', '#Musclebuild Nutrition']
    },

    {
      ...
      likes: 134,
      comments: 5,
      hashtags: ['#gym', '#workout', '#Musclebuild Nutrition']
    }
  ];
